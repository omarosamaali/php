...
<?php if( $current_file_name == 'gl_journal.php' ) {?>
		table.tablestyle2 td:first-child, table.tablestyle2 td:nth-child(3) {  width:8%; }
		table.tablestyle2 td:nth-child(2) {  width: 40%; }
		table.tablestyle2 td input[name="AmountDebit"], table.tablestyle2 td input[name="AmountCredit"] {  min-width: 100px; }
		table.tablestyle2 td input[name="LineMemo"]{ max-width:150px; }
		table.tablestyle2 td:nth-child(2) select { max-width: none; width: calc(100% - 5px) !important;}
 <?php } else { ?>
                                          /* table.tablestyle2 td:first-child, table.tablestyle2 td:nth-child(3) {  width: 1%; }*/
...
<?php if($current_file_name == 'sales_order_entry.php' ) { ?>
		#items_table center table tbody tr td.tableheader:nth-child(2) { width: 30%; }
		#items_table center table tbody tr td #_stock_id_sel select#stock_id.combo { max-width: none; width: 100% !important; }
		#delivery input, #delivery textarea { max-width: none; width: 100% !important; }
<?php } if($current_file_name == 'po_entry_items.php' ) { ?>
		table.tablestyle2 td:first-child,	table.tablestyle2 td:nth-child(2) {  width: 50%; }
...
<?php  if($current_file_name != 'gl_bank.php') { ?>
		table.tablestyle2 td:first-child, table.tablestyle2 td:nth-child(3){	width: 100%;	}
<?php } ?>
		input.amount{ min-width: 75px; }	
		input.date { min-width:98px;}		
		...
		div#items_table table tr:first-child {  background-color: #eeeeee; }
					...
					<?php if($current_file_name == 'po_entry_items.php' ) { ?>
						...
						input.date + a > img { margin-top: 10px;    padding-left: 3px; }
		...
		<?php }else if( $current_file_name== 'transfers.php' || $current_file_name== 'adjustments.php') { ?>
				@media (max-width: 500px){
					...
					table { width: 100%; }
					div#items_table table td {display: revert !important;   float: none !important;   }
				}
		...
		<?php } elseif($current_file_name == 'profit_loss.php' || $current_file_name == 'balance_sheet.php' || $current_file_name == 'gl_trial_balance.php' || $current_file_name == 'bank_inquiry.php' || $current_file_name == 'gl_account_inquiry.php' ||  $current_file_name == 'journal_inquiry.php' || $current_file_name == 'bank_account_reconcile.php' ||  $current_file_name == 'search_dimensions.php'|| $current_file_name == 'bom_edit.php'|| $current_file_name == 'bom_cost_inquiry.php'|| $current_file_name == 'search_work_orders.php'|| $current_file_name == 'stock_status.php'|| $current_file_name == 'stock_movements.php'|| $current_file_name == 'supplier_allocation_inquiry.php'||  $current_file_name == 'supplier_inquiry.php'||  $current_file_name == 'supplier_allocation_main.php'|| $current_file_name == 'customer_allocation_main.php'  || $current_file_name == 'sales_orders_view.php'  || $current_file_name == 'customer_inquiry.php'|| $current_file_name == 'customer_allocation_inquiry.php' || $current_file_name == 'sales_deliveries_view.php' || $current_file_name == 'create_recurrent_invoices.php' || $current_file_name == 'po_search_completed.php'){?>
			@media (max-width: 768px){
				...
				<?php if($current_file_name =='sales_orders_view.php' ||$current_file_name =='po_search_completed.php'||$current_file_name =='search_work_orders.php'){?>
				#_orders_tbl_span table:first-of-type{ width: auto !important; }
				#_orders_tbl_span center {overflow-x: auto !important;overflow-y: none !important; }
				#_orders_tbl_span table:first-of-type td{ width: auto !important;display: revert !important;float: none !important; }
				<?php  }elseif($current_file_name =='customer_allocation_inquiry.php' || $current_file_name =='supplier_allocation_inquiry.php'){?>
				#_doc_tbl_span table:first-of-type{ width: auto !important; }
				#_doc_tbl_span center {overflow-x: auto !important;overflow-y: none !important; }
				#_doc_tbl_span table:first-of-type td{ width: auto !important;display: revert !important;float: none !important; }
				<?php  }elseif($current_file_name =='customer_inquiry.php' || $current_file_name =='supplier_inquiry.php'){?>
				#_trans_tbl_span table:first-of-type{ width: auto !important; }
				#_trans_tbl_span center {overflow-x: auto !important;overflow-y: none !important; }
				#_trans_tbl_span table:first-of-type td{ width: auto !important;display: revert !important;float: none !important; }
				<?php  }elseif($current_file_name =='stock_movements.php'){?>
				#doc_tbl table:first-of-type{ width: auto !important; }
				#doc_tbl center {overflow-x: auto !important;overflow-y: none !important; }
				#doc_tbl table:first-of-type td{ width: auto !important;display: revert !important;float: none !important; }
				<?php  }elseif($current_file_name =='stock_status.php'){?>
				#status_tbl table:first-of-type{ width: auto !important; }
				#status_tbl center {overflow-x: auto !important;overflow-y: none !important; }
				#status_tbl table:first-of-type td{ width: auto !important;display: revert !important;float: none !important; }
				<?php  }elseif($current_file_name =='bom_cost_inquiry.php'){?>
				#_page_body table:first-of-type{ width: auto !important; }
				#_page_body center {overflow-x: auto !important;overflow-y: none !important; }
				#_page_body table:first-of-type td{ width: auto !important;display: revert !important;float: none !important; }
				<?php  }elseif($current_file_name =='journal_inquiry.php'){?>
				#_journal_tbl_span table:first-of-type{ width: auto !important; }
				#_journal_tbl_span center {overflow-x: auto !important;overflow-y: none !important; }
				#_journal_tbl_span table:first-of-type td{ width: auto !important;display: revert !important;float: none !important; }
				<?php  }elseif($current_file_name =='bank_inquiry.php'){?>
				#trans_tbl table:first-of-type{ width: auto !important; }
				#trans_tbl center {overflow-x: auto !important;overflow-y: none !important; }
				#trans_tbl table:first-of-type td{ width: auto !important;display: revert !important;float: none !important; }
				<?php  }elseif($current_file_name =='gl_trial_balance.php'){?>
				#balance_tbl table:first-of-type{ width: auto !important; }
				#balance_tbl center {overflow-x: auto !important;overflow-y: none !important; }
				#balance_tbl table:first-of-type td{ width: auto !important;display: revert !important;float: none !important; }
				<?php  }elseif($current_file_name =='profit_loss.php'){?>
				#pl_tbl table:first-of-type{ width: auto !important; }
				#pl_tbl center {overflow-x: auto !important;overflow-y: none !important; }
				#pl_tbl table:first-of-type td{ width: auto !important;display: revert !important;float: none !important; }
				<?php  }?>
		...
		<?php }elseif($current_file_name == 'attachments.php' || $current_file_name == 'view_print_transaction.php' || $current_file_name == 'void_transaction.php' || $current_file_name == 'shipping_companies.php' || $current_file_name == 'shipping_companies.php' ||$current_file_name == 'item_tax_types.php' || $current_file_name == 'tax_groups.php' || $current_file_name == 'tax_types.php' || $current_file_name == 'security_roles.php' || $current_file_name == 'users.php' || $current_file_name == 'gl_account_classes.php' || $current_file_name == 'gl_account_types.php' || $current_file_name == 'gl_accounts.php' || $current_file_name == 'exchange_rates.php' || $current_file_name == 'currencies.php' || $current_file_name == 'gl_quick_entries.php' || $current_file_name == 'bank_accounts.php' || $current_file_name == 'tags.php' || $current_file_name == 'dimension_entry.php' || $current_file_name == 'work_centres.php' || $current_file_name == 'where_used_inquiry.php' || $current_file_name == 'purchasing_data.php' || $current_file_name == 'prices.php' || $current_file_name == 'item_units.php' || $current_file_name == 'item_categories.php' || $current_file_name == 'sales_kits.php' || $current_file_name == 'locations.php' || $current_file_name == 'item_codes.php'){?>
			...
			<?php if($current_file_name =='where_used_inquiry.php'){?>
				#_usage_table_span table:first-of-type{ width: auto !important; }
				#_usage_table_span table:first-of-type td{ width: auto !important;display: revert !important;float: none !important; }
			<?php  } ?>
		...
		<?php 	}  	if($current_file_name == 'customers.php'){ ?>
			img[title="Search customers"] { display: inline-block !important; margin-right: 5px;}
		...
		<?php } ?>
		<?php if( $current_file_name =='gl_account_inquiry.php'){ ?>
			.tablestyle{
				min-width: 100% !important;
			}
			.tablestyle tr td ,.tablestyle tr td a{
				font-size: 10px;
			}
		<?php } 
		
	if($current_file_name == 'reports_main.php') {?>
		br {    line-height: 0px;}
	<?php } ?>
		</style>